...
namespace IndividualTaxCalcAPI.Entity.Context
{
    public partial class IndividualTaxCalcAPIContext : DbContext
    {
        public IndividualTaxCalcAPIContext(DbContextOptions<IndividualTaxCalcAPIContext> options)
            : base(options)
        {
        }
