...
namespace IndividualTaxCalcAPI.Entity.UnitofWork
{
    ...
    public interface IUnitOfWork : IDisposable
    {
        ...
        IndividualTaxCalcAPIContext Context { get; }
        int Save();
        Task<int> SaveAsync();
    }
    ...
    {
        public IndividualTaxCalcAPIContext Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(IndividualTaxCalcAPIContext context)
        {
            Context = context;
            _disposed = false;
        }
